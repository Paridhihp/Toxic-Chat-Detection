...
public class Adminregister implements ActionListener {
      ...
      Adminregister() {
            ...
            l8 = new JLabel("New Admin Please Register");
            ImageIcon img = new ImageIcon("adminregister.png");
            ...
            if (ae.getSource().equals(b1)) {
                  if (t1.getText().isEmpty() || (t2.getText().isEmpty()) || (t3.getText().isEmpty())
                        ...
                        try {
                              ...
                              String SecurityName = (String) t6.getText();
                              ...
                              PreparedStatement ps = c
                                          .prepareStatement("insert into Adminregister values(?,?,?,?,?,?)");
                              ps.setString(1, Company_name);
                              ps.setString(2, Email);
                              ps.setString(3, Contact);
                              ps.setString(4, Admin_name);
                              ps.setString(5, SecurityName);
