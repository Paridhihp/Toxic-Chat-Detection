...
public class ALogin implements ActionListener {
    ...
    ALogin() {
        ...
        ImageIcon img = new ImageIcon("adminlogin.png");
        l5 = new JLabel(img);
        f = new JFrame("AdminLogin");
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource().equals(b2)) {
            try {
                ...
                String qs = "select * from Adminregister where email=? and password=?";
